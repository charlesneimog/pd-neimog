...
void rbb_init_sinTable(rbb_sintable *info_ptr)
{
	...
	info_ptr->table_alloc = (float*)getbytes((info_ptr->tableLength) * sizeof(float));
...
void rbb_free_sinTable(rbb_sintable *info_ptr)
{
	if (info_ptr->table_alloc)
		freebytes(info_ptr->table_alloc, info_ptr->tableLength * sizeof(float));
...
void rbb_init_shortDelay(rbb_delaybuff_short *info_ptr)
{
	...
	info_ptr->buff_alloc = (float*)getbytes((info_ptr->buff_length) * sizeof(float));
...
void rbb_free_shortDelay(rbb_delaybuff_short *info_ptr)
{
	if (info_ptr->buff_alloc)
		freebytes(info_ptr->buff_alloc, info_ptr->buff_length * sizeof(float));
